...
var style_KabupatenTemanggung_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Luas 2022");
    var labelText = "";
    size = 0;
    var labelFont = "13.325px \'NewsGoth Cn BT\', sans-serif";
    var labelFill = "rgba(0, 62, 220, 1)";
    var textAlign = "left";
    var offsetX = 8;
    var offsetY = 3;
    var placement = 'point';
    ...
    if (value > 0.000000 && value <= 375.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 375.000000 && value <= 750.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 750.000000 && value <= 1125.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 1125.000000 && value <= 20000.000000) {
            style = [ new ol.style.Style({
